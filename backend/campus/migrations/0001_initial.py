    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "degree",
                    models.CharField(
                        choices=[("Бакалавр", "Bachelor"), ("Магістр", "Master")],
                        max_length=63,
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("Залікова робота", "Zr Task"),
                            ("Розрахункова робота", "Rr Task"),
                            ("Лабораторна робота", "Lr Task"),
                            ("Курсова робота", "Cr Task"),
                        ],
                        max_length=63,
                    ),
                ),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                related_name="teachers_groups", to="campus.specialty"
            ),
        ),
        migrations.AddField(
            model_name="user",
            name="specialities",
            field=models.ManyToManyField(
                related_name="teachers", to="campus.specialty"
            ),
        ),
        migrations.AddField(
            model_name="user",
